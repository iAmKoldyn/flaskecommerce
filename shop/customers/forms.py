...
class CustomerRegisterForm(FlaskForm):
    ...
    password = PasswordField('Пароль: ', [validators.DataRequired(), validators.EqualTo('подтвердить', message='Оба пароля должны совпадать! ')])
    ...
    profile = FileField('Профиль', validators=[FileAllowed(['jpg','png','jpeg','gif'], 'Только картинки')])
